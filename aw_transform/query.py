...
def bucket_transform(btransform: Union[BucketTransform, dict], ds,
...
def filter_keyvals(tfilter: Union[KeyVals, dict], events: List[Event], ds,
...
# @deprecated
def include_keyvals(tfilter: Union[KeyVals, dict], events: List[Event], ds,
                    limit=-1, start=None, end=None):
    return filter_keyvals(tfilter, events, ds, limit=limit, start=start, end=end)


# @deprecated
def exclude_keyvals(tfilter: Union[KeyVals, dict], events: List[Event], ds,
                    limit=-1, start=None, end=None):
...
def timeperiod_intersect(tfilter: Union[TimeperiodIntersect, dict], events: List[Event], ds,
